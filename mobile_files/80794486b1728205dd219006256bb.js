...
var _cf = _cf || []
    ...
    gd: function () {
        ...
        var d = Math["random"]()
            , k = bmak["pi"](1e3 * d / 2)
            , l = d + "";
        return l = l["slice"](0, 11) + k,
            bmak["get_browser"](),
            bmak["bc"](),
            bmak["bmisc"](),
        a + ",uaend," + bmak["xagg"] + "," + bmak["psub"] + "," + bmak["lang"] + "," + bmak["prod"] + "," + bmak["plen"] + "," + bmak["pen"] + "," + bmak["wen"] + "," + bmak["den"] + "," + bmak["z1"] + "," + bmak["d3"] + "," + n + "," + o + "," + m + "," + r + "," + i + "," + c + "," + b + "," + bmak["bd"]() + "," + t + "," + l + "," + e + ",loc:" + bmak["loc"]
    },
    ...
    bc: function () {
        ...
        bmak["xagg"] = a + (t << 1) + (e << 2) + (n << 3) + (o << 4) + (m << 5) + (r << 6) + (i << 7) + (c << 8) + (b << 9) + (d << 10) + (k << 11) + (l << 12) + (s << 13)
    },
    bmisc: function () {
    ...
    bd: function () {
        ...
        a["push"]("vib:" + k);
        var l = "function" == typeof navigator["getBattery"] ? 1 : 0;
        a["push"]("bat:" + l);
        ...
        try {
            ...
            if (bmak["ke_cnt"] < bmak["ke_cnt_lmt"] && e) {
                ...
                0 == i && 0 == c && 0 == b && n >= 32 && (n = 3 == t && n >= 32 && n <= 126 ? -2 : n >= 33 && n <= 47 ? -3 : n >= 112 && n <= 123 ? -4 : -2),
                    l != bmak["prevfid"] ? (bmak["fidcnt"] = 0,
                        bmak["prevfid"] = l) : bmak["fidcnt"] = bmak["fidcnt"] + 1;
                if (0 == bmak["isIgn"](n)) {
                    var u = bmak["ke_cnt"] + "," + t + "," + k + "," + n + "," + s + "," + d + "," + l;
                    null != e["isTrusted"] && !1 === e["isTrusted"] && (u += ",0"),
                        u += ";",
                        bmak["kact"] = bmak["kact"] + u,
                        bmak["ke_vel"] = bmak["ke_vel"] + bmak["ke_cnt"] + t + k + n + d + l,
                        bmak["ta"] += k
                } else
                    o = 0
            }
    ...
    getforminfo: function () {
        for (var a = "", t = "", e = document["getElementsByTagName"]("input"), n = -1, o = 0; o < e["length"]; o++) {
            var m = e[o]
                ...
                , l = m["getAttribute"]("autocomplete");
            null == l ? n = -1 : (l = l["toLowerCase"](),
                n = "off" == l ? 0 : "on" == l ? 1 : 2);
            var s = m["defaultValue"]
                , u = m["value"]
                , _ = 0
                , f = 0;
            s && 0 != s["length"] && (f = 1),
            !u || 0 == u["length"] || f && u == s || (_ = 1),
        ...
        if (document["cookie"])
            for (var t = a + "=", e = document["cookie"]["split"]("; "), n = 0; n < e["length"]; n++) {
                ...
                if (0 === o["indexOf"](t)) {
                    ...
                    if (!bmak["bm"])
                        return m;
                    if (-1 != m["indexOf"]("~") || -1 != decodeURIComponent(m)["indexOf"]("~"))
                        return m
                }
            }
        return !1
    ...
    bpd: function () {
        ...
        try {
            ...
            var k = bmak["ke_vel"] + bmak["me_vel"] + bmak["doe_vel"] + bmak["dme_vel"] + bmak["te_vel"] + bmak["pe_vel"]
                , l = bmak["get_cf_date"]() - bmak["start_ts"]
                , s = bmak["pi"](bmak["d2"] / 6)
                , u = bmak["fas"]()
                ,
                ...
                , h = ""
                , g = "";
            void 0 !== bmak["mn_r"][1] && (h = bmak["mn_r"][1]),
            void 0 !== bmak["mn_r"][2] && (g = bmak["mn_r"][2]),
        ...
        try {
            var y = bmak["od"](bmak["cs"], bmak["api_public_key"])["slice"](0, 16)
                ...
                , j = bmak["get_cf_date"]()
                , E = y + bmak["od"](C, y) + bmak["sensor_data"];
        ...
        try {
            if (0 == bmak["sdfn"]["length"])
                ...
                bmak["sd_debug"](",s6:");
                for (var S = 0; S < bmak["sdfn"]["length"]; S++)
                    if (bmak["sd_debug"](",a-" + bmak["sdfn"][S]),
                        document["getElementById"](bmak["sdfn"][S])) {
                        bmak["sd_debug"](",b"),
                            document["getElementById"](bmak["sdfn"][S])["value"] = bmak["sensor_data"];
                        var x = document["getElementById"](bmak["sdfn"][S])["value"];
                        "string" == typeof x ? bmak["sd_debug"](",c-" + x["slice"](0, 5)) : bmak["sd_debug"](",c-null")
                    } else
                        bmak["sd_debug"](",d")
            }
        } catch (a) {
    ...
    mn_get_new_challenge_params: function (a) {
        ...
        if (null != a)
            for (var n = 0; n < a["length"]; n++) {
                var o = a[n];
                if (o["length"] > 0) {
                    for (var m = o[0], r = bmak["mn_abck"] + bmak["start_ts"] + o[2], i = o[3], c = o[6], b = 0; b < bmak["mn_lcl"] && (1 == m && bmak["mn_lc"][b] != r && bmak["mn_ld"][b] != i); b++)
                        ;
                    b == bmak["mn_lcl"] && (t = n,
                    2 == c && (e = n))
                }
        ...
        return null != e ? a[e] : null != t ? a[t] : null
    },
    mn_poll: function () {
        if (0 == bmak["mn_state"]) {
            var a = bmak["get_mn_params_from_abck"]()
                , t = bmak["mn_get_new_challenge_params"](a);
            null != t && (bmak["mn_update_challenge_details"](t),
    ...
    mn_h: function (a) {
        ...
        for (var c = r["length"] / 4 + 2, b = Math["ceil"](c / 16), d = new Array(b), k = 0; k < b; k++) {
            d[k] = new Array(16);
            for (var l = 0; l < 16; l++)
                d[k][l] = r["charCodeAt"](64 * k + 4 * l) << 24 | r["charCodeAt"](64 * k + 4 * l + 1) << 16 | r["charCodeAt"](64 * k + 4 * l + 2) << 8 | r["charCodeAt"](64 * k + 4 * l + 3) << 0
        }
        var s = i / Math["pow"](2, 32);
        d[b - 1][14] = Math["floor"](s),
...
try {
    ...
    bmak["disFpCalOnTimeout"] || setTimeout(bmak["calc_fp"], 100);
    for (var i = 0; i < 3; i++)
